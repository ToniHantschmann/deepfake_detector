...
\usepackage[
  title={
  Spielbasierte Deepfake-Sensibilisierung an Öffentlichen Displays}, % Do not forget to capitalize your title correctly, you may use the following page to help you: https://capitalizemytitle.com/
