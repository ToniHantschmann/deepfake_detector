...
Zunächst ein paar kurze Worte zur Datenqualität. 
Die Ergebnisse der Umfragen und der internen Statistiken sind vollständig, 
liegen (mit Ausnahme des Antwortwertes von Frage 3, der um -1 korrigiert werden musste) alle in plausiblen Bereichen und haben keine erkennbaren Eingabefehler. 
Im Nachhinein stellte sich heraus, dass die Fachbereiche aus Frage 19 nicht ideal für den Ort der Studie gewählt wurden und 85.7\% ein Eintrag bei "Anderes" gemacht hatten. 
Deshalb erfolgte noch eine Kategorisierung der Antworten bei "Anderes". 
...
Damit liegt der Anteil der Nutzer (N=42) die die Umfrage vollständig abgeschlossen haben bei 97.6\%. 
Von den 30 Nutzern die in der zweiten Phase das Spiel gespielt haben (Unbeaufsichtigt), haben nur 2 Personen an der Umfrage teilgenommen. 
Deshalb wurden die Ergebnisse der zweiten Phase getrennt ausgewertet und die zwei Umfrageergebnisse nicht berücksichtigt. 
Der Anteil der Nutzer die auf die Studie angesprochen wurde, hat dies in der Frage 12 "Was hat dich auf das Spiel aufmerksam gemacht?" angegeben. 
Diese Antwortmöglichkeit wurde auch noch im Nachhinein als weitere Kategorie hinzugefügt. 
Während der Studie hat sich ein kritischer Fehler in der Anwendung gezeigt, der diese in der Videovergleichsansicht abstürzen lies. 
Dieser Fehler war bis zum Zeitpunkt des Schreibens nicht reproduzierbar und trat pro Studientag ca. 1-2 mal auf. 
...
Die detaillierte Auswertung der Daten basiert auf den Ergebnissen der ersten Phase, wenn sich in der zweiten Phase nennenswerte Abweichungen davon gezeigt haben wird dies zusätzlich erwähnt. 
